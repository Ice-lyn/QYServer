...
function getBook(text, pl) {
    network.httpGet("https://yunzhiapi.cn/API/fqmfxs.php?token=UUkR4A3CJNfW&name=" + text, (code, res) => {
...
function getBookTxt(url, pl) {
    network.httpGet(url, (_code, res) => {
        ...
        pl.sendForm(fm, (player, id) => {
            ...
            const newUrl = `https://yunzhiapi.cn/API/fqmfxs.php?token=UUkR4A3CJNfW&href=${newHref}&num=${newNum}`;
